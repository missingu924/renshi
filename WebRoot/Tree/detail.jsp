		...
		<table width="700" align="center" class="detail_table detail_table-bordered"> 
			<tr> 
				<td> 
					...
					<td><%=StringUtil.getNotEmptyStr(domainInstance.getData_soure())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("open") %>: 
				</td> 
					<td><%=StringUtil.getNotEmptyStr(domainInstance.getOpen())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("select_ids") %>: 
				</td> 
					<td><%=StringUtil.getNotEmptyStr(domainInstance.getSelect_ids())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("fiter") %>: 
				</td> 
					<td><%=StringUtil.getNotEmptyStr(domainInstance.getFiter())%></td> 
			</tr> 
		</table> 
