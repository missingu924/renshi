...
<% 
	...
	// 对象实例 
	AuthOfficeObj domainInstance = new AuthOfficeObj(); 
	// 该功能基本路径 
	...
	{ 
		domainInstance = (AuthOfficeObj) domainInstanceObj; 
	} 
 
	// 是否是修改 
	boolean isModify = domainInstance.findKeyValue() > 0; 
	// 唯一性检查用的字段 
	String keyCol = "officecode"; 
%> 
<html> 
	<head> 
		<base target="_self" /> 
		...
		if(!checkNull("officename","<%=domainInstance.getPropertyCnName("officename")%>")) return false; 
		...
		<form name="addOrModifyForm" id="addOrModifyForm" action="<%=contextPath%>/<%=basePath%>/Servlet?method=addOrModify4this" method="post"> 
			...
			<table width="700" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
				...
				<tr> 
					...
					<td> 
						<input name="officecode" type="text" id="officecode" value="<%=StringUtil.getNotEmptyStr(domainInstance.getOfficecode(),"")%>" size="20"  <%=isModify?"readOnly":""%>> 
						<font color="red">*</font> 
				...
				<tr> 
					...
					<td> 
						<input name="officecomment" type="text" id="officecomment" value="<%=StringUtil.getNotEmptyStr(domainInstance.getOfficecomment(),"")%>" size="20"  > 
					</td> 
				</tr> 
			</table> 
