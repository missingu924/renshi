...
<% 
	...
	// 该功能对象查询条件实例 
	 com.wuyg.auth.searchcondition.AuthLogLoginSearchCondition domainSearchCondition = (com.wuyg.auth.searchcondition.AuthLogLoginSearchCondition) request.getAttribute("domainSearchCondition"); 
	// 用户信息 
