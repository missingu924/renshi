	...
	<body> 
		...
		<table width="600" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
			...
			<tr> 
				...
				<td><%=DictionaryUtil.getDictValueByDictKey("角色字典",domainInstance.getRolecode())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("functioncode") %>: 
				</td> 
				<td><%=DictionaryUtil.getDictValueByDictKey("权限项字典",domainInstance.getFunctioncode())%></td> 
			</tr> 
		</table> 
