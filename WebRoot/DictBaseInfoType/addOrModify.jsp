...
<% 
	...
	// 对象实例 
	DictBaseInfoTypeObj domainInstance = new DictBaseInfoTypeObj(); 
	// 用户信息 
	...
	{ 
		domainInstance = (DictBaseInfoTypeObj) domainInstanceObj; 
	} 
 
	// 是否是修改 
	boolean isModify = domainInstance.findKeyValue() > 0; 
	// 唯一性检查用的字段 
	String keyCol = "base_info_type_code"; 
%> 
<html> 
	<head> 
		<base target="_self" /> 
		...
		if(!checkNull("base_info_type_name","<%=domainInstance.getPropertyCnName("base_info_type_name")%>")) return false; 
		...
		<form name="addOrModifyForm" id="addOrModifyForm" action="<%=contextPath%>/<%=basePath%>/Servlet?method=addOrModify4this" method="post"> 
			...
			<table width="700" align="center" class="detail_table detail_table-bordered"> 
				...
				<tr> 
					...
					<td> 
						<input name="base_info_type_code" type="text" id="base_info_type_code" value="<%=StringUtil.getNotEmptyStr(domainInstance.getBase_info_type_code(),"")%>" size="20"  <%=isModify?"readOnly":""%>> 
						<font color="red">*</font> 
			...
			if(true==<%=isModify%>)
			{
				setReadonly("base_info_type_code");
			}
			</script>
		</form> 
	</body> 
