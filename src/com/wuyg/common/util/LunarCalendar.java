...
public class LunarCalendar
{
	...
	/**
	 * 用来表示1900年到2099年间农历年份的相关信息，共24位bit的16进制表示，其中： 1. 前4位表示该年闰哪个月； 2. 5-17位表示农历年份13个月的大小月分布，0表示小，1表示大； 3. 最后7位表示农历年首（正月初一）对应的公历日期。
	 * 
	 ...
	 *            农历日
	 * @param isLeapMonth
	 *            该月是否是闰月 [url=home.php?mod=space&uid=7300]@return[/url] 返回农历日期对应的公历日期，year0, month1, day2.
	 */
	...
	final public static String lunarToSolar(String lunarDay)
	{
		try
		{
			...
			int[] solars = lunarToSolar(StringUtil.parseInt(lunarDay.substring(0, 4)), StringUtil.parseInt(lunarDay.substring(5, 5 + 2)), StringUtil.parseInt(lunarDay.substring(8, 8 + 2)), false);
