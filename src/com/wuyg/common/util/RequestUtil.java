...
public class RequestUtil
{
	...
	public static void downloadFile(HttpServletRequest request, HttpServletResponse response, List dataList, Class domainInstanceClz) throws Exception, IllegalAccessException
	{
		...
		downloadFile(request, response, dataList, properties, uniqueIndexProperties, fileName);
	}

	// 文件下载
	public static void downloadFile(HttpServletRequest request, HttpServletResponse response, List dataList, LinkedHashMap<String, String> instanceProperties, List<String> uniqueIndexProperties, String fileName) throws Exception
	{
		// 生成excel文件
		String filePath = request.getRealPath("/download/") + "/" + fileName + "_" + TimeUtil.nowTime2str("yyyyMMddHHmmss") + ".xls";
